...
<body>
    ...
    <div class="container-form">
        ...
        <form action="create.php" method="post">
            ...
            <select name="statut_recherche" id="statut_recherche" placeholder="Recherche de stage"
                value="<?= $user["statut_recherche"] ?>" required>
            ...
            <select name="type_postulation" placeholder="Type de postulation" id="type_postulation"
                value="<?= $user["type_postulation"] ?>" required>
            ...
            <select name="methode_postulation" placeholder="Méthode de postulation" id="methode_postulation"
                value="<?= $user["methode_postulation"] ?>" required>
            ...
            <select name="type_contrat" placeholder="Type de contrat" id="type_contrat"
                value="<?= $user["type_contrat"] ?>" required>
                <option>Stage</option>
                <option>CDD</option>
                <option>CDI</option>
